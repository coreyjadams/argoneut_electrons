/**
 * \file CFAlgoShowerTimeMatchCOPY.h
 *
 * \ingroup CMTool
 * 
 * \brief Class def header for a class CFAlgoShowerTimeMatchCOPY
 *
...
/** \addtogroup CMTool
    ...
    @{*/
#ifndef RECOTOOL_CFALGOSHOWERTIMEMATCHCOPY_H
#define RECOTOOL_CFALGOSHOWERTIMEMATCHCOPY_H
...
namespace cmtool {
  /**
     \class CFAlgoShowerTimeMatchCOPY
     User implementation for CFloatAlgoBase class
     doxygen documentation!
  */
  class CFAlgoShowerTimeMatchCOPY : public CFloatAlgoBase {
    
  public:
    
    /// Default constructor
    CFAlgoShowerTimeMatchCOPY();
    
    /// Default destructor
    virtual ~CFAlgoShowerTimeMatchCOPY(){};
