#ifndef RECOTOOL_CFALGOSHOWERWIREMATCHCOPY_CXX
#define RECOTOOL_CFALGOSHOWERWIREMATCHCOPY_CXX

#include "CFAlgoShowerWireMatchCOPY.h"
#include "LArUtil/GeometryUtilities.h"

namespace cmtool {

  //-------------------------------------------------------
  CFAlgoShowerWireMatchCOPY::CFAlgoShowerWireMatchCOPY() : CFloatAlgoBase()
  //-------------------------------------------------------
  {
  ...
  //-----------------------------
  void CFAlgoShowerWireMatchCOPY::Reset()
  //-----------------------------
  {
  ...
  //----------------------------------------------------------------------------------------------
  float CFAlgoShowerWireMatchCOPY::Float(const std::vector<const cluster::ClusterParamsAlg*> &clusters)
  //----------------------------------------------------------------------------------------------
  {
...
//	    std::cout << "wireDistU < 0 (as per WireMatch)" << "\n";
  ...
  //-----------------------------------------------------------------------------------------------
  float CFAlgoShowerWireMatchCOPY::getScore( std::vector<float> showerRange, std::vector<float> otherRange)
  //-----------------------------------------------------------------------------------------------
  {
...
//      std::cout << "overlap condition from line 195 met (Shower Wire Match)" << "\n";
  ...
  //------------------------------
  void CFAlgoShowerWireMatchCOPY::Report()
  //------------------------------
  {
  }
    
  //------------------------------------------------------------------------------------
  void CFAlgoShowerWireMatchCOPY::WireIDtoWorld(int wireID, double time, double angle, std::vector<double>& yz)
  //------------------------------------------------------------------------------------
  {
