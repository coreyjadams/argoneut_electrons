#ifndef DEDXGETROUGHSTARTPOINT_CXX
#define DEDXGETROUGHSTARTPOINT_CXX
...
dEdxGetRoughStartPoint::dEdxGetRoughStartPoint()
{
  _name = "dEdxGetRoughStartPoint";
  _N    = 20;
  _angleMatrix = std::vector<std::vector<float> >(_N, std::vector<float>(_N));

}

void dEdxGetRoughStartPoint::do_params_fill(::cluster::cluster_params & cluster) {
