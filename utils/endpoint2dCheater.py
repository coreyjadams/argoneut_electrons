...
import ROOT
import larlite
from ROOT import larlite, larutil, argoutils
import sys
import os
import argparse
import time
...
def main(**args):
  ...
  if args['data_output'] == None:
      args['data_output'] = args['source'][0].replace(".root","") + "_endpoint2d.root"
      if args['verbose']:
  ...
  # 
  endpointCheater=argoutils.SinglesEndpointCheater()
  my_proc.add_process(endpointCheater)
