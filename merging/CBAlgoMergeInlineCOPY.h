/**
 * \file CBAlgoMergeInlineCOPY.h
 *
 * \ingroup CMTool
 * 
 * \brief Class def header for a class CBAlgoMergeInlineCOPY
...
/** \addtogroup CMTool
    ...
    @{*/
#ifndef RECOTOOL_CBALGOMERGEINLINECOPY_H
#define RECOTOOL_CBALGOMERGEINLINECOPY_H
...
namespace cmtool {
  ...
  */
  class CBAlgoMergeInlineCOPY : public CBoolAlgoBase{
    
  public:
    
    /// Default constructor
    CBAlgoMergeInlineCOPY();
    
    /// Default destructor
    virtual ~CBAlgoMergeInlineCOPY(){};
