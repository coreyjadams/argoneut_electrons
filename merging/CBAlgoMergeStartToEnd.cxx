...
namespace cmtool {
      ...
      const ::cluster::ClusterParamsAlg &cluster2)
  {
    ...
    float maxDist = 3 ; //semicolon; Can't use "int" for non-integer (like 0.5).
    ...
    if ( overlap && ( actDist1 < maxDist || actDist2 < maxDist )) 
      ...
      return true;
    //changed line
    else if ((actDist1 < 4.5 || actDist2 < 4.5 || actDist3 < 0.4 || actDist4 < 0.4) && (cluster1.GetParams().angle_2d <= cluster2.GetParams().angle_2d + 0.025 || cluster1.GetParams().angle_2d >= cluster2.GetParams().angle_2d - 0.025))
      return true;
    else 
      return false;
