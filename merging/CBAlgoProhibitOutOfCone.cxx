#ifndef RECOTOOL_CBALGOPROHIBITOUTOFCONE_CXX
#define RECOTOOL_CBALGOPROHIBITOUTOFCONE_CXX
...
namespace cmtool {
  ...
  //--------------------------------------------------------
  bool CBAlgoProhibitOutOfCone::Bool(const ::cluster::ClusterParamsAlg &cluster1,
