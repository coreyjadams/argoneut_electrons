...
def full_samples_noIter():
    electron_data_file = "/data_linux/argoneut/dedx_files/electron_shower_reco_noIter.root"
    photon_data_file = "/data_linux/argoneut/dedx_files/photon_shower_reco_noIter.root"
    ...
    # For MC:
    electron_sim_file = "/data_linux/argoneut/argoneut_single_electron/electron_sample_larlite_lowerE_mergeall_endpoint2d_match_shower_showerNoIter.root"
    photon_sim_file = "/data_linux/argoneut/argoneut_single_photon/photon_sample_larlite_lowerE_mergeall_endpoint2d_match_shower_showerNoIter.root"

    sim_calibration_file = "/data_linux/argoneut/calibration_files/wireByWireCorrections_sim.pkl"

    electron_sim_module = showerCalo(
        electron_sim_file, sim_calibration_file,None, mc=True, producer="showerrecoNoIter")
    print "Finished Electron Sim."
    photon_sim_module = showerCalo(
        photon_sim_file, sim_calibration_file,None, mc=True, producer="showerrecoNoIter")
...
def full_simch_samples():
    ...
    photon_sim_file = "/data_linux/argoneut/argoneut_single_photon/larlite_photon_lowerE_simch_mergeall_endpoint2d_match_shower.root"
...
def lite_simch_samples():
    ...
    electron_sim_module.run(500)
    photon_sim_module.run(500)
