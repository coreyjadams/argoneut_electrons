...
#
SUBDIRS := utils vertex merging matching spacepoints analysis filter #ADD_NEW_SUBDIR ... do not remove this comment from this line
#####################################################################################
#
# COMPILATION...
#
...
doxygen:
	...
	@mkdir -p $(LARLITE_USERDEVDIR)/argoneut_electrons/doc/dOxygenMyProject
	@doxygen $(LARLITE_USERDEVDIR)/argoneut_electrons/doc/doxygenMyProject.script
